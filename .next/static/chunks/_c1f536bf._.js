(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_c1f536bf._.js", {
...
/* Pill colour helper */ const pillColor = (h)=>h === 'operational' ? 'bg-green-500' : h === 'degraded' ? 'bg-yellow-500' : h === 'maintenance' ? 'bg-blue-500' : 'bg-red-500';
const StatusPage = ()=>{
    _s();
    ...
    /* 🔍 Debug — see the incidents in console */ console.table(rows.map((r)=>({
            id: r.id,
