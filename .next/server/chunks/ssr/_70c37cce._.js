...
const PRODUCTS = [
    {
        ...
        checkout: {
            starter: ("TURBOPACK compile-time value", "price_1S8VHbHzk6SAuULRWzlW8Ns4") || '#',
            growth: ("TURBOPACK compile-time value", "price_1S8VHbHzk6SAuULRWzlW8Ns4") || '#',
            pro: ("TURBOPACK compile-time value", "price_1S8VHbHzk6SAuULRWzlW8Ns4") || '#'
        }
    },
    {
        key: 'sales',
...
// --- Consulting packages (30% reduced pricing) ---
const CONSULTING = [
    {
        key: 'audit',
        title: 'Starter Audit',
...
function TierCard({ product, tier }) {
    ...
    const link = product.checkout[tier.key];
...
//# sourceMappingURL=_70c37cce._.js.map