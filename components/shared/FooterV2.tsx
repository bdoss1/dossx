...
DossX delivers AI-driven software and automation solutions worldwide, empowering businesses with innovative products and expert development.              </p>
              <h5 className="mb-3 font-satoshi text-2xl font-medium leading-[1.1]">Address</h5>
              <p>
                1919 McKinney Avenue <br /> Suite 1000<br />
                Dallas, TX 75201  
              </p>
          ...
          <p className="mt-10 border-t pt-5 text-center dark:border-dark">  © {new Date().getFullYear()} DossX — All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
