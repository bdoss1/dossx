...
Tell us what you need—features, timeline, success metrics. A quick discovery call turns ideas into a clear project brief.
              </p>
            </RevealWrapper>
            ...
            <RevealWrapper className="text-center">
              ...
              <p className="text-base leading-[1.4] tracking-[0.32px]">
You get a fixed-bid proposal with milestones, scope, and budget. Green-light it when everything looks perfect.
              </p>
            </RevealWrapper>
            ...
            <RevealWrapper className="text-center">
              ...
              <p className="text-base leading-[1.4] tracking-[0.32px]">
Our engineers spin up sprints, ship prototypes, and keep you in the loop with weekly demos. No surprises—just progress.
              </p>
            </RevealWrapper>
            ...
            <RevealWrapper className="text-center">
              ...
              <p className="text-base leading-[1.4] tracking-[0.32px]">
We launch, optimize, and hand over documentation plus training. Your new AI-powered solution goes live, ready to scale.              </p>
            </RevealWrapper>
          </div>
        </RevealWrapper>
